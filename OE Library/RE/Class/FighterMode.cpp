...
#if Y0DC
FIGHTERMODEMANAGER_SetCommandSet FighterModeManager::ASM_SetCommandset = (FIGHTERMODEMANAGER_SetCommandSet)Memory::ReadCall2(PatternScan("E8 ? ? ? ? 49 8D 8D ? ? ? ? 49 03 CE"));
FIGHTERMODEMANAGER_ToBattleStart FighterModeManager::ASM_ToBattleStart = (FIGHTERMODEMANAGER_ToBattleStart)PatternScan("40 53 48 83 EC ? 48 8B 41 ? 48 8B D9 48 8B 48 ? 48 85 C9 74 ? E8 ? ? ? ? 48 85 C0 74 ? 48 8B 10");
#else
